...
ui.检查更新按钮.on("click", () => {
    threads.start(function () {
        let url = [
            'https://ghproxy.com/https://raw.githubusercontent.com/cx1937410794/ku/main/0mk/服务/检查更新.js',
...
ui.留言按钮.click(function () {
    alert("    你好,我是你们的后端维护员,我曾经像你们一样是一个普普通通的战士,我跟大家一样冲锋在疫情一线,2020.1.24除夕傍晚16点左右,我后送一名来自武汉转车的同事,兢兢业业与大家并肩作战直到疫情缓和,在次年的一次工作组检查中,我没及时给领导开门被断定存在隐患,之后被挂职一个月,并调离工作岗位;我不服但又无奈,最终我选择远离,来证明对我的不公,后来想想,在领导面前再多的解释也是多余...\n能遇到一个好好领导真的很幸运!")
});