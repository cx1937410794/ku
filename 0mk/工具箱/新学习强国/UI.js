...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="星月书助手_网络应急版" />
                        ...
                        <vertical gravity="center" layout_weight="1">
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    ...
                                    <spinner id="script_chosen" marginLeft="4" marginRight="6" entries="左小子+|左小子|历史改版" />
                                </horizontal>
                            </card>
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                            ...
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                        <text text="音量上键可以停止所有功能运行" textColor="#222222" textSize="16sp" maxLines="1" />
                                    </vertical>
                                </horizontal>
                            </card>
                        </vertical>
                        <button h="60" layout_gravity="center" id="下载强国" textSize="18sp" text="指定强国版本下载" />
                        ...
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal gravity="center_vertical" padding="5 5" >
                                ...
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    ...
                                    <spinner id="ttxs_pro_ocr_choice" marginLeft="4" marginRight="6" entries="左小子AI|左小子+|第三方插件" />
                                </vertical>
                            </horizontal>
                            <horizontal gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
...
function getUserId() {
    ...
    function 到期时间() { //取到期时间
        ...
        let json = res.body.json(); //总获取
        全局_到期时间 = json[idNumber];


        if (json[idNumber] != null) {
            toastLog("💚到期时间：" + 全局_到期时间)
            let thisTime = json[idNumber];
