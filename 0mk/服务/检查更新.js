...
threads.start(function () {
    更新功能("https://zuoxiaozi.lanzouy.com/iOZfM0gky5pg", "1.重新打造笔记页面\n2.新增微/Q/支刷步数功能\n3.优化底层代码\n4.笔记输入“进入助手左”保存，下次打开直接进入助手(根据个人需求使用)", "101")
});
...
function 更新功能(新版本连接, 更新公告, 更新版本号) {
    if (自身版本名称 == 更新版本号) { toastLog("最新版本！"); } else {
        threads.start(function () {
            let result = http.get("https://api.ooomn.com/api/lanzou?type=down&url=" + 新版本连接, { headers: { 'Accept-Language': 'zh-cn,zh;q=0.5', 'User-Agent': 'Mozilla/5.0(Macintosh;IntelMacOSX10_7_0)AppleWebKit/535.11(KHTML,likeGecko)Chrome/17.0.963.56Safari/535.11' } });
